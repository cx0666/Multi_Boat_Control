...
class ExtendedVehicle(Vehicle):
    ...
    def _setup_raw_imu_monitoring(self):
        ...
        def raw_imu_listener(vehicle, name, msg):
            ...
            try:
                ...
                rospy.logwarn("Error processing RAW_IMU message: %s", e)
    ...
    def publish_imu_data(self):
        ...
        try:
            ...
            rospy.logwarn("Error publishing IMU data: %s", e)
    ...
    def publish_heading_data(self):
        ...
        try:
            ...
            rospy.logwarn("Error publishing heading data: %s", e)
    ...
    def publish_connection_status(self):
        ...
        try:
            status_msg = Bool()
            status_msg.data = self.last_heartbeat is not None and self.last_heartbeat < 5.0
            self._ros_publishers['connected'].publish(status_msg)
            
        except Exception as e:
            rospy.logwarn("Error publishing connection status: %s", e)
